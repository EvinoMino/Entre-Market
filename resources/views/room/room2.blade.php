...
<body>
    ...
    <div class="mySlides">
        <img src="/images/photoa.jpg" alt="Slide 1">
    </div>

    <div class="mySlides">
        <img src="/images/photob.jpg" alt="Slide 2">
    </div>

    <div class="mySlides">
        <img src="/images/photoc.jpg" alt="Slide 3">
    </div>
    <div class="mySlides">
        <img src="/images/photod.jpg" alt="Slide 3">
    </div>
  ...
  <ul id="leaderboard"></ul>
        ...
        <div class="details-container">
          ...
          <h2>Balenciaga Pro</h2>
          <p class="price">Current Bid: <span id="currentBid">200.200,00</span></p>
          <p class="start-price">Rp 200.000,00</p>
        ...
        <a href="#" onclick="placeBid(15000)" id="bid15000" class="bid-button">
          ...
          <p class="description">Quality    : Like New</p>
          <p class="description">Made From  : Spanyol (2018)</p>
          <p class="description">Size       : 43</p>
          
        </div>
      </div>
      <script src="script.js"></script>
</body>
    <script src="/js/room/room2.js"></script>
    <script>
